...
for i in range(clients_num):
    ...
    print("client{} model initialize complete".format(i))
...
for fl in range(fl_epochs):
    ...
    torch.save(gNB_model.state_dict(),models_dir/f'fl{fl}gNB.pth')
    ...
    print('fl{}gNB_model Test Accuracy  {} %'.format(fl,client,100*(gNB_correct/gNB_total)))
    logging.info('fl{}gNB_model Test Accuracy  {} %'.format(fl, client, 100 * (gNB_correct / len(gNB_test_dataloader))))
