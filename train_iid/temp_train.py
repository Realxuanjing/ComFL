...
from model import VGGnet,SimpleCNN,ComplexCNN,ComplexPlusCNN
import matplotlib.pyplot as plt


# ---------------------设置自定义文件---------------------
top_model_name = 'ComplexMore_114_Flavg_CP'
...
model=ComplexPlusCNN(num_classes=10)


learning_rate=0.001 #设置学习率
num_epochs=16   #本地训练次数
# Tweak_time = 32
train_batch_size=64
test_batch_size=64
fl_epochs=30 #联邦学习次数
